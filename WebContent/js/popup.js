...
function uploadimg()
{
pop("/tjsqyygl/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/tjsqyygl/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/tjsqyygl/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/tjsqyygl/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/tjsqyygl/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/tjsqyygl/js/uploaddoc.jsp","docupload",300,77)
}

function uploaddoc2()
{
pop("/tjsqyygl/js/uploaddoc2.jsp","docupload",300,77)
}

function uploaddoc3()
{
pop("/tjsqyygl/js/uploaddoc3.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/tjsqyygl/js/dialogclose.gif  />';
